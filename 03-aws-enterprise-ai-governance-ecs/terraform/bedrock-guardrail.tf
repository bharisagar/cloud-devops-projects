resource "aws_bedrock_guardrail" "ai_governance" {
  ...
  description               = "Enterprise AI governance guardrail for ECS based AI gateway."
  blocked_input_messaging   = "This request was blocked by the enterprise AI governance policy. Please rephrase the request."
  blocked_outputs_messaging = "The generated response was blocked by the enterprise AI governance policy."
...
resource "aws_bedrock_guardrail_version" "ai_governance" {
  ...
  description   = "Published version for the ECS enterprise AI governance platform."
}
